...
db.restaurants.find({"grades.grade": "A", cuisine: {$ne: "Chinese"}, borough: "Manhattan"},{name:1, _id:0})
...
db.companies.find({name: /facebook/i}, {name:1, _id:0})
...
db.companies.find({name: /Twitter/i},{name:1, _id:0, category_code:1, founded_year:1})
