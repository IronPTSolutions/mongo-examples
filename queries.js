...
db.restaurants.remove({ "address.zipcode": '10466'})
...
db.companies.find({$and: [{"founded_day": 1}, {"number_of_employees": {$ne: 50}}, {"category_code": {$ne: "web"}}]}, {founded_day: 1, name: 1}).limit(5)
...
db.companies.find({$and: [{"acquisition.acquired_month": 1}, {"acquisition.acquired_year": 2014}]}, {acquisition: 1, name: 1})