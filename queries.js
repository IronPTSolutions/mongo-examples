...
db.companies.find({ $or: [{'category_code':{$ne:'web'}}, {'number_of_employees':{$ne:50}}], 'founded_day': 1}, {'founded_day':1, 'name':1}).limit(5)
...
db.companies.find({'acquisition.acquired_month':1, 'acquisition.acquired_year':2014},{'name':1, 'acquisition':1}).pretty() 