...
db.companies.find({$or: [{"founded_year": 2000}, {"number_of_employees": 20}]}).sort(descending("number_of_employees")) 
// ---REVISAR----- 
...
db.companies.find({$and: [{"category_code": {$ne: "web"}}, {"category_code": {$ne: "social"}}]}, {name: 1, category_code: 1}).limit(20)
...
db.companies.find({$and: [{"acquired_month": 1},{"acquired_year": 2014}]}, {acquisition: 1, name: 1})