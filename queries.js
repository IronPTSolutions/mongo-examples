...
db.restaurants.find({"grades.score": {$gt: 90}}).pretty() // -> ¿ .$[] solo para update ?
...
db.companies.find({"founded_year": { $ne: "June"}}, {name: 1, "founded_year": 1, _id: 0}).skip(50)
...
db.companies.find({"founded_day": 1, "number_of_employees": {$ne: 50}, "category_code": {$ne: "web"}}, {name: 1, "founded_day": 1, _id: 0}).limit(5)
...
db.companies.find({"acquisition.acquired_year": 2014, "acquisition.acquired_month": 1}, {name: 1, "acquisition": 1, _id: 0})