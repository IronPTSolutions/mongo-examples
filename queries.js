...
db.companies.find({category_code:1}.limit(50))
...
db.companies.find({$or:[{"founded_year": 2005},{"number_of_employees": {$eq: 20}}]}.sort({"number_of_employees":-1}))
...
db.companies.find({$and: [{"category_code": {$ne: "web"}}, {"category_code": {$ne: "social"}}]},{_id:0, name: 1, category_code: 1}.limit(20))
...
db.companies.find({$and: [{"founded_day":1}, {number_of_employees:{$lte: 50}}, {category_code: {$ne: "web"}}]},{_id: 0, name: 1, founded_day: 1}.limit(5))

//Find all the companies which the price_amount of the acquisition was 40.000.000. Sort them by name.
db.companies.find({"acquisition.price_amount": 40000000},{_id: 0, name:1}.sort({name:1}))
