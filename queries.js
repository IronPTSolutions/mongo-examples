...
db.companies.find({ "category_code": { $ne: "web" }, "category_code": { $ne: "social" } }, { "name": 1, "category_code": 1 }).limit(20)
...
db.companies.find({ "founded_day": 1, "number_of_employees": { $ne: 50 }, "category_code": { $ne: "web" } }, { "name": 1, "founded_day": 1 }).limit(5)
...
db.companies.find({ "acquisition.acquired_year": 2014, "acquisition.acquired_month": 1 }, { "name": 1, "acquisition": 1 })