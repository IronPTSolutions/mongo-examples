...
db.companies.find({ $or: [ {"founded_year": 2000}, {"number_of_employees": 20} ] }).sort( { "amount": -1 } ).pretty()
//7. Find all the companies that do not include web nor social on their category_code. Limit the search to 20 documents and retrieve only their name and category_code.
db.companies.find({"category_code": {$ne: "social"},"category_code": {$ne: "web"}},{"name": 1,"category_code": 1,"_id":0}).limit(20).pretty()
...
db.companies.find({"founded_day": 1,"number_of_employees":{$ne: 50},"category_code": "web"},{"founded_day": 1, "name": 1, "_id": 0}).limit(5)
