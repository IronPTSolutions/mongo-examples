...
db.companies.find({ $or: [{ 'founded_year': 2000}, {'number_of_employees': 20}]}).sort()
...
db.companies.find({'founded_day': 1,  $or: [{'category_code': {$ne: 'web'}},{'number_of_employees': {$ne: 50}}]}, {'founded_day': 1, name: 1, _id:0}).limit(5)
