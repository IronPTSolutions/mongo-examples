...
db.companies.find({ "category_code": "enterprise", "founded_year": 2005 }, { "_id": 0, "name": 1, "category_code": 1, "founded_year": 1}).pretty()
...
db.companies.find({ $and: [ { "founded_day": 1 }, { "number_of_employees": { $ne: 50 } }, { "category_code": { $ne: "web" } } ] }, { "_id": 0, "founded_day": 1, "name": 1 }).limit(5)
...
db.companies.find({ $and: [ { "acquisition.acquired_year": 2014 }, { "acquisition.acquired_month": 1 } ] }, { "_id": 0, "acquisition": 1, "name": 1 }).pretty()