...
db.companies.find( {name: "Twitter"}, {_id: 0, name: 1, category_code: 1, founded_year: 1}).pretty()
...
db.companies.find( {category_code: "enterprise"}, {_id: 0, name: 1, category_code: 1, founded_year: 1}).pretty()
