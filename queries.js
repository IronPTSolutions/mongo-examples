...
b.companies.find( {name: "Twitter"}, {_id: 0, name: 1, category_code: 1, founded_year: 1}).pretty()
...
db.companies.find( {category_code: "enterprise",founded_year:2005}, {_id: 0, name: 1, category_code: 1, employees: 1}).pretty()
...
db.companies.find( {category_code: {$ne: "web"}, category_code: {$ne: "social"}}, {_id:0, name: 1,  category_code:1} ).limit(20).pretty()
...
db.companies.find({founded_day: 1, number_of_employees: {$ne: 50}, category_code: {$ne: "web"}}, {_id: 0, name: 1, founded_day: 1} ).limit(5).pretty()
// Find all the companies which the price_amount of the acquisition was 40.000.000. Sort them by name.
db.companies.find( {"acquisition.price_amount": 40000000}, {_id:0, name: 1,  number_of_employees:1} ).sort( { name: 1 } ).pretty()
