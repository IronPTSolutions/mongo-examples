...
// db.restaurants.find({"grades.$.score":{$gt: 90}, cuisine:{ $ne: "Bakery"}}) -- PENDIENTE CONSEGUIR EL PRIMER ELEMENTO DEL ARRAY GRADES
...
db.restaurants.find({"grades.grade": "A", borough:{ $ne: "Manhattan"}, cuisine:{ $ne: "Chinese"}})
