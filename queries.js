...
db.restaurants.find({}, {"name": 1, "id": 1, "restaurant_id": 1, "cusine": 1,"borough": 1 }).pretty()

//Find all the restaurants and display only the fields restaurant_id, name, borough and zip code.
db.restaurants.find({}, {"name": 1, "restaurant_id": 1, "borough": 1, "address.zipcode": 1 }).pretty()
...
db.companies.find({$nor: [{category_code: "social"}, {category_code: "web"}]}, {name:1, category_code: 1, _id:0 }).limit(20).pretty()
...
db.companies.find({founded_day: 1, $nor:[{number_of_employees: 50}, {category_code:"web"}]}, {founded_day: 1, name:1, _id:0}).limit(5).pretty()
...
db.companies.find({"acquisition.acquired_month": 1, "acquisition.acquired_year": 2014}, {acquisition: 1, name: 1, _id:0}).pretty()
