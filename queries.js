...
db.companies.find({founded_day: 1, number_of_employees: {$lt: 50}, category_code: {$ne: 'web'}}, {founded_day: 1, name: 1, _id: 0}).limit(5)
...
db.companies.find({'acquisition.acquired_month': 1, 'acquisition.acquired_year': 2014}, {name: 1, 'acquisition.acquired_month': 1, 'acquisition.acquired_year': 1, _id: 0})